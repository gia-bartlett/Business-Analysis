...
Businesses hold a formal definition of the architecture of their business and any proposed change must align with this.  
Even small changes affect multiple processes, IT systems and databases.  
The business architecture helps to provide increased visibility and effectiveness. Once a high level plan or blueprint of the organisation exists, it is possible to evaluate various scenarios for change in terms of their impact and effectiveness, and ensure that any changes to be undertaken can be aligned with this overall business architecture.  

## 8.3 Definition of Business Architecture:  

A blueprint of the enterprise that provides a common understanding of the organisation that can be used to align strategic objectives and tactical demands - Business Architecture Guild (2014)  
